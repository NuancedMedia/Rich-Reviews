...
/*
		...
		<form id="rr-admin-options-form" action="" method="post">
			...
			<div style="float:left;width:30%">
				...
				<h4><?php _e('Name Field', 'rich-reviews'); ?></h4>
				<label for="form-name-label"><?php _e('Form Label: ', 'rich-reviews'); ?></label><input type="text" name="form-name-label" value="<?php echo $options['form-name-label']; ?>" /><br>
				<label for="form-name-display"><?php _e('Display Field: ', 'rich-reviews'); ?></label><input type="checkbox" name="form-name-display" value="checked" <?php echo $options['form-name-display'] ?> /><br/>
				<label for="form-name-require"><?php _e('Require Field: ', 'rich-reviews'); ?></label><input type="checkbox" name="form-name-require" value="checked" <?php echo $options['form-name-require'] ?> />
				<br>
				<h4><?php _e('Reviewer Image Field', 'rich-reviews'); ?></h4>
				<label for="form-reviewer-image-label"><?php _e('Form Label: ', 'rich-reviews'); ?></label><input type="text" name="form-reviewer-image-label" value="<?php echo $options['form-reviewer-image-label']; ?>" /><br>
				<label for="form-reviewer-image-display"><?php _e('Display Field: ', 'rich-reviews'); ?></label><input type="checkbox" name="form-reviewer-image-display" value="checked" <?php echo $options['form-reviewer-image-display'] ?> /><br/>
				<label for="form-reviewer-image-require"><?php _e('Require Field: ', 'rich-reviews'); ?></label><input type="checkbox" name="form-reviewer-image-require" value="checked" <?php echo $options['form-reviewer-image-require'] ?> />
				<br>
				<h4><?php _e('Email Field', 'rich-reviews'); ?></h4>
				<label for="email-label"><?php _e('Form Label: ', 'rich-reviews'); ?></label><input type="text" name="form-email-label" value="<?php echo $options['form-email-label']; ?>" /><br>
				<label for="form-email-display"><?php _e('Display Field: ', 'rich-reviews'); ?></label><input type="checkbox" name="form-email-display" value="checked" <?php echo $options['form-email-display'] ?> /><br/>
				<label for="form-email-require"><?php _e('Require Field: ', 'rich-reviews'); ?></label><input type="checkbox" name="form-email-require" value="checked" <?php echo $options['form-email-require'] ?> />
				<br>
				<h4><?php _e('Title Field', 'rich-reviews'); ?></h4>
				<label for="form-title-label"><?php _e('Form Label: ', 'rich-reviews'); ?></label><input type="text" name="form-title-label" value="<?php echo $options['form-title-label']; ?>" /><br>
				<label for="form-title-display"><?php _e('Display Field: ', 'rich-reviews'); ?></label><input type="checkbox" name="form-title-display" value="checked" <?php echo $options['form-title-display'] ?> /><br/>
				<label for="form-title-require"><?php _e('Require Field: ', 'rich-reviews'); ?></label><input type="checkbox" name="form-title-require" value="checked" <?php echo $options['form-title-require'] ?> />
				<br>
				<h4><?php _e('Content Field', 'rich-reviews'); ?></h4>
				<label for="form-content-label"><?php _e('Form Label: ', 'rich-reviews'); ?></label><input type="text" name="form-content-label" value="<?php echo $options['form-content-label']; ?>" /><br>
				<label for="form-content-display"><?php _e('Display Field: ', 'rich-reviews'); ?></label><input type="checkbox" name="form-content-display" value="checked" <?php echo $options['form-content-display'] ?> /><br/>
				<label for="form-content-require"><?php _e('Require Field: ', 'rich-reviews'); ?></label><input type="checkbox" name="form-content-require" value="checked" <?php echo $options['form-content-require'] ?> />
				<br>
				<h4><?php _e('Review Image Field', 'rich-reviews'); ?></h4>
				<!--TODO: Maybe make this an image array, and potentially allow video uploads -->
				<label for="form-reviewed-image-label"><?php _e('Form Label: ', 'rich-reviews'); ?></label><input type="text" name="form-reviewed-image-label" value="<?php echo $options['form-reviewed-image-label']; ?>" /><br>
				<label for="form-reviewed-image-display"><?php _e('Display Field: ', 'rich-reviews'); ?></label><input type="checkbox" name="form-reviewed-image-display" value="checked" <?php echo $options['form-reviewed-image-display'] ?> /><br/>
				<label for="form-reviewed-image-require"><?php _e('Require Field: ', 'rich-reviews'); ?></label><input type="checkbox" name="form-reviewed-image-require" value="checked" <?php echo $options['form-reviewed-image-require'] ?> />
				<br>
				<h4><?php _e('Submit Button', 'rich-reviews'); ?></h4>
				<label for="form-submit-text"><?php _e('Submit Text: ', 'rich-reviews'); ?></label><input type="text" name="form-submit-text" value="<?php echo $options['form-submit-text']; ?>" /><br>
				<br>
			</div>
			<div style="float:right;width:65%">
				...
				<label for="show_form_post_title"><?php _e('Include Post Titles - this will include the title and a link to the form page for every review.', 'rich-reviews'); ?></label>
				<br />
				...
				<label for="snippet_stars"><?php _e('Star Snippets - this will change the averge rating displayed in the snippet shortcode to be stars instead of numerical values.', 'rich-reviews'); ?></label>
				<br />

				<input type="color" name="star_color" value="<?php echo $options['star_color'] ?>">
				<label for="star_color"><?php _e('Star Color - the color of the stars on reviews', 'rich-reviews'); ?></label>
				<br />
				...
				<label for="display_full_width"><?php _e('Display Full width - This option will display the reviews in full width block format. Default will dsplay the reviews in blocks of three.', 'rich-reviews'); ?></label>
				<br />
				<input type="checkbox" name="show_date" value="checked" <?php echo $options['show_date'] ?> />
				<label for="show_date"><?php _e('Display the date that the review was submitted inside the review.', 'rich-reviews'); ?></label>
				<br />
				<input type="checkbox" name="credit_permission" value="checked" <?php echo $options['credit_permission'] ?> />
				<label for="credit_permission"><?php _e('Give Credit to Nuanced Media - this option will add a small credit line and a link to Nuanced Media\'s website to the bottom of your reviews page', 'rich-reviews'); ?></label>
				<br />
				<input type="checkbox" name="return-to-form" value="checked" <?php echo $options['return-to-form'] ?> />
				<label for="return-form"><?php _e('Upon submission of the review form, the page will automatically scroll back to the location of the form.', 'rich-reviews'); ?></label>
				<br />
				...
				<label for="require_approval"><?php _e('Require Approval - this sends all new reviews to the pending review page. Unchecking this will automatically publish all reviews as they are submitted.', 'rich-reviews'); ?></label>
				<br />
				...
				<label for="approve_authority"><?php _e('Authority level required to Approve Pending Posts', 'rich-reviews'); ?></label>
				<br />
				<input type="checkbox" name="send-email-notifications" value="checked" <?php echo $options['send-email-notifications'] ?> />
				<label for="require_approval"><?php _e('Send Notification Emails - This will send an automatic email to the admin every time a new pending review is submitted.', 'rich-reviews'); ?></label>
				<br />
				<br />
				<label for "admin-email"><?php _e('Admin Email - The email to which notifications are sent.', 'rich-reviews'); ?></label>
